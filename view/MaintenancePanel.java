 ...
 *
 * <p>The stock tab adds, restocks, reprices, and removes item types; the money
 * tab replenishes and collects the change fund; and the summary tab reports the
 * starting inventory, ending inventory, and sales since the last stocking.</p>
 */
