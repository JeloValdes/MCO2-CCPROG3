 ...
 *
 * <p>It shows what the machine has available, lets the customer feed in pieces
 * of any denomination, and offers the vending actions: taking the inserted cash
 * back, buying the selected item, and, on a special machine, moving on to build
 * a custom ramen.</p>
 */
